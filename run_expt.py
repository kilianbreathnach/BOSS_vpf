...
cosmo_dir = "{0}/WMAP".format(out_dir)
...
mk_zfile("{0}/nbar-cmass-dr11v1-N-Anderson.dat".format(sdss_dir),
         "{0}/cmass-dr11v1-N-Anderson.dat.fits".format(sdss_dir), "WMAP")
